...
bool GLLayerRenderer::Init(uint32_t width, uint32_t height, uint32_t format,
  ...
  if (!bo_.modifier) {
	 ...
	 egl_image_ = gl_->eglCreateImageKHR(gl_->display, EGL_NO_CONTEXT,
  	...
  	uint64_t modifier = bo_.modifier;
	EGLint modifier_low = (EGLint) bo_.modifier;
	EGLint modifier_high = (EGLint) (bo_.modifier>>32);
	const EGLint image_attrs[] = {
        EGL_WIDTH,                     (EGLint)width,
        EGL_HEIGHT,                    (EGLint)height,
        EGL_LINUX_DRM_FOURCC_EXT,      DRM_FORMAT_XRGB8888,
        EGL_DMA_BUF_PLANE0_FD_EXT,     (EGLint)fd_,
        EGL_DMA_BUF_PLANE0_PITCH_EXT,  (EGLint)bo_.pitches[0],
        EGL_DMA_BUF_PLANE0_OFFSET_EXT, (EGLint)bo_.offsets[0],
        EGL_DMA_BUF_PLANE0_MODIFIER_LO_EXT, modifier_low,
        EGL_DMA_BUF_PLANE0_MODIFIER_HI_EXT, modifier_high,
        EGL_DMA_BUF_PLANE1_FD_EXT,     (EGLint)fd_,
        EGL_DMA_BUF_PLANE1_PITCH_EXT,  (EGLint)bo_.pitches[1],
        EGL_DMA_BUF_PLANE1_OFFSET_EXT, (EGLint)bo_.offsets[1],
